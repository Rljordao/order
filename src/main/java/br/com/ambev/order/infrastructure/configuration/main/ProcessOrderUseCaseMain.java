...
public class ProcessOrderUseCaseMain {
    ...
    public ProcessOrderUseCase processOrderUseCase(OrderIdGeneratorUseCase orderIdGeneratorUseCase,
                                                   OrderMapper orderMapper, CreateOrderUseCase createOrderUseCase, ExistsByOrderNumberUseCase existsByOrderNumberUseCase) {
        return new ProcessOrderUseCaseImpl(orderIdGeneratorUseCase, orderMapper, createOrderUseCase, existsByOrderNumberUseCase);
    }
}
